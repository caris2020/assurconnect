-- Script de réparation complète pour environnement Docker
-- Exécutez ce script dans le conteneur PostgreSQL

-- ===== 1. NETTOYAGE COMPLET =====
SELECT '=== RÉPARATION DOCKER COMPLÈTE ===' as info;
...
SELECT '=== RÉPARATION DOCKER TERMINÉE AVEC SUCCÈS ===' as info;

DO $$
BEGIN
    RAISE NOTICE 'RÉPARATION DOCKER TERMINÉE!';
    RAISE NOTICE 'Base de données prête pour l''application Docker.';
    RAISE NOTICE 'Prochaines étapes:';
    RAISE NOTICE '1. Redémarrer le conteneur backend';
    RAISE NOTICE '2. Tester l''API avec curl';
    RAISE NOTICE '3. Vérifier que les données se chargent';
END $$;
